-- ============================================================
-- SCRIPT MAESTRO ACTUALIZADO - Sistema de Seguro de Vehiculos
-- UASD - INF-8236-C2 - Actividad 4.2
-- Version: Completa (DDL + DML + DQL)
...
-- ============================================================
-- PARTE 1: DDL - CREAR ESTRUCTURA (Del archivo DDL)
-- ============================================================
...
CREATE TABLE Cliente (
    ...
    Cliente_FechaRegistro        DATETIME        NOT NULL DEFAULT NOW(),
...
CREATE TABLE Agente (
    Agente_ID                     INT             AUTO_INCREMENT NOT NULL,
...
CREATE TABLE Cobertura (
    Cobertura_ID                  INT             AUTO_INCREMENT NOT NULL,
...
CREATE TABLE Taller (
    Taller_ID                     INT             AUTO_INCREMENT NOT NULL,
...
CREATE TABLE SolicitudCotizacionPoliza (
    SolicitudCotizacionPoliza_ID                    INT             AUTO_INCREMENT NOT NULL,
...
CREATE TABLE Poliza (
    Poliza_ID                     INT             AUTO_INCREMENT NOT NULL,
...
CREATE TABLE FacturaPoliza (
    FacturaPoliza_ID             INT             AUTO_INCREMENT NOT NULL,
...
CREATE TABLE Siniestro (
    Siniestro_ID                  INT             AUTO_INCREMENT NOT NULL,
...
CREATE TABLE EvaluacionSiniestro (
    EvaluacionSiniestro_ID                       INT             AUTO_INCREMENT NOT NULL,
...
SELECT '============================================================' AS Mensaje;
SELECT 'DDL ejecutado correctamente.' AS Mensaje;
SELECT 'Base de datos recreada: SeguroVehiculos' AS Mensaje;
SELECT '============================================================' AS Mensaje;

-- ============================================================
-- PARTE 2: DML - INSERTAR DATOS (Del archivo DML)
-- ============================================================

INSERT INTO TipoVehiculo (TipoVehiculo_Descripcion, TipoVehiculo_TarifaBase) VALUES
('Automovil Sedan', 5000.00), ('SUV Compacta', 7000.00), ('Camioneta Pickup', 6500.00), ('Motocicleta', 2500.00), ('Camion Ligero', 9000.00),
('Minivan Familiar', 8000.00), ('Automovil Deportivo', 12000.00), ('Jeep 4x4', 8500.00), ('Camion Pesado', 15000.00), ('Vehiculo Electrico', 10000.00),
('Hatchback', 4800.00), ('Coupe', 7600.00), ('Taxi Ejecutivo', 6200.00), ('Microbus', 11000.00), ('Furgon Comercial', 9800.00),
('Crossover', 7300.00), ('Vehiculo Hibrido', 9200.00), ('Van Escolar', 10500.00), ('Camion de Reparto', 11500.00), ('Todo Terreno Premium', 13500.00);

INSERT INTO Cliente (Cliente_Cedula, Cliente_Nombre, Cliente_Apellido, Cliente_FechaNacimiento, Cliente_Telefono, Cliente_Email, Cliente_Direccion, Cliente_Ciudad) VALUES
...
INSERT INTO Agente (Agente_Cedula, Agente_Nombre, Agente_Apellido, Agente_Telefono, Agente_Email, Agente_FechaIngreso, Agente_ComisionPorcentaje) VALUES
...
INSERT INTO Cobertura (Cobertura_Nombre, Cobertura_Descripcion, Cobertura_PrimaBase, Cobertura_Deducible) VALUES
...
INSERT INTO Taller (Taller_Nombre, Taller_Direccion, Taller_Telefono, Taller_Email, Taller_Responsable) VALUES
...
INSERT INTO Vehiculo (Vehiculo_Cliente_ID, Vehiculo_TipoVehiculo_ID, Vehiculo_Placa, Vehiculo_Marca, Vehiculo_Modelo, Vehiculo_Anio, Vehiculo_Color, Vehiculo_ValorAsegurado, Vehiculo_VIN) VALUES
...
INSERT INTO SolicitudCotizacionPoliza (SolicitudCotizacionPoliza_ClienteID, SolicitudCotizacionPoliza_VehiculoID, SolicitudCotizacionPoliza_AgenteID, SolicitudCotizacionPoliza_CoberturaID, SolicitudCotizacionPoliza_FechaSolicitud, SolicitudCotizacionPoliza_Estatus, SolicitudCotizacionPoliza_Observaciones, SolicitudCotizacionPoliza_MontoCotizado) VALUES
...
INSERT INTO Poliza (Poliza_SolicitudCotizacionPolizaID, Poliza_ClienteID, Poliza_VehiculoID, Poliza_AgenteID, Poliza_CoberturaID, Poliza_Numero, Poliza_FechaEmision, Poliza_FechaVencimiento, Poliza_Estatus, Poliza_PrimaAnual, Poliza_Deducible, Poliza_Observaciones) VALUES
...
INSERT INTO FacturaPoliza (FacturaPoliza_PolizaID, FacturaPoliza_Numero, FacturaPoliza_FechaEmision, FacturaPoliza_MontoTotal, FacturaPoliza_Estatus, FacturaPoliza_Descripcion) VALUES
...
INSERT INTO Pago (Pago_FacturaPolizaID, Pago_Cliente_ID, Pago_Fecha, Pago_Monto, Pago_Metodo, Pago_Referencia, Pago_Estatus, Pago_Observaciones) VALUES
...
INSERT INTO Siniestro (Siniestro_PolizaID, Siniestro_VehiculoID, Siniestro_Numero, Siniestro_FechaOcurrencia, Siniestro_FechaReporte, Siniestro_Tipo, Siniestro_Descripcion, Siniestro_LugarOcurrencia, Siniestro_MontoEstimadoDano, Siniestro_Estatus) VALUES
...
INSERT INTO EvaluacionSiniestro (EvaluacionSiniestro_SiniestroID, EvaluacionSiniestro_TallerID, EvaluacionSiniestro_Fecha, EvaluacionSiniestro_Perito, EvaluacionSiniestro_DescripcionDanos, EvaluacionSiniestro_MontoAprobado, EvaluacionSiniestro_Observaciones, EvaluacionSiniestro_Estatus) VALUES
...
SELECT 'Cada tabla recibio 20 registros.' AS Resultado;
SELECT '============================================================' AS Resultado;